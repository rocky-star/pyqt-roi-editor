...
The view only reports what the user did — a click, a request to finish
the shape being drawn — and leaves every decision to the main window.
The keyboard is watched by the window itself, because a menu holds the
focus for long enough that the view cannot be relied on to receive it.
"""
